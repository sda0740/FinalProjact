	...
	<input type="hidden" value="${storeCode}" name="booksCode">
		...
		<table>
			...
			<tr>
				...
				<td><p>
						<input type="text" id="spinner13" name="book13"
			...
			<tr>
				...
				<td><p>
						<input type="text" id="spinner14" name="book14"
			...
			<tr>
				...
				<td><p>
						<input type="text" id="spinner15" name="book15"
